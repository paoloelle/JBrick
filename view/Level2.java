...
public class Level2 extends Map implements KeyListener, ActionListener {


    public boolean enableLevel2 = false;
    ...
    public Level2() {
        ...
        imagePath = "images/backgroundLevel2.jpg";
        ...
        for (int i = 0; i < map.length; i++)
            for (int j = 0; j < map[0].length; j++)
                ...
                if (map[i][j] > 0) {
                    ...
                    if (map[i][j] == 1) {
                        g.setColor(new Color(14, 76, 255, 139));
                    ...
                    if (map[i][j] == 2) {
                        g.setColor(new Color(35, 255, 20, 139));
                        g.fillRect(j * 75 + 60, i * 35 + 40, brickWidth, brickHeight);
                        g.setColor(Color.WHITE);
                        g.drawRect(j * 75 + 60, i * 35 + 40, brickWidth, brickHeight);
                    }
                    ...
                    if (map[i][j] == 3) {
                        g.setColor(new Color(255, 32, 215, 139));
                        g.fillRect(j * 75 + 60, i * 35 + 40, brickWidth, brickHeight);
                        g.setColor(Color.WHITE);
                        g.drawRect(j * 75 + 60, i * 35 + 40, brickWidth, brickHeight);
                    }
    ...
    public void paint(Graphics g) {
        ...
        // draw pause window
        if (enableLevel2 && enablePause && !enableWin && !ballLose) {
        ...
        if (enableWin) {
            ...
            g.setFont(new Font("SansSerif", Font.BOLD, 30));
            g.drawString("(press SPACE BAR to go to start window)", 100, 250);
        ...
        if (ballLose && !enableLose) {
            ...
            g.drawString("(press SPACE BAR to restart the game)", 220, 400);
    ...
    public void keyPressed(KeyEvent e) {
        ...
        if (enableLevel2 && !enablePause && !enableWin && !ballLose && !enableLose) {
        ...
        if (e.getKeyCode() == KeyEvent.VK_P && !ballLose && enableLevel2 && !enableLose)
            if (enablePause)
                enablePause = false;
